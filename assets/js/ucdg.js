...
if (document.documentElement.lang === "en") {
	index = ["/assets/includes/menu-include-en.html", "/assets/includes/footer-include-en.html"];
}
if (document.documentElement.lang === "fr") {
	index = ["/assets/includes/menu-include-fr.html", "/assets/includes/footer-include-fr.html"];
}
